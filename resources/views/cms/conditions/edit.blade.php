...
<div ng-controller="CmsConditionEditCtrl">
    <div class="row">
        <div class="panel panel-default">
          ...
          <!-- start form -->
          <form id="condition_form" name="frm" novalidate>
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <!-- field 1:conditionid -->
            <input type="hidden" name="id" value="{{ $condition->id }}" id="conditionid">
            ...
            <h5>
              ...
              <div class="col-lg-8 col-lg-offset-2">
                ...
                <label class="radio-inline">
                  <input type="radio" name="is_common" ng-model="condition.is_common" id="inlineRadio1" value="0" @if($condition->is_common==0) checked="checked" @endif>No
                </label>
                <label class="radio-inline">
                  <input type="radio" name="is_common" ng-model="condition.is_common" id="inlineRadio2" value="1" @if($condition->is_common==1) checked="checked" @endif>Yes
                </label>
          ...
          <div class="text-center">
            <button class="btn btn-lg btn-info col-xs-12 col-xs-offset-0 col-md-4 col-md-offset-4" ng-click="updateCondition( $event, condition )">Submit</button>
          </div>
