        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <table class="table table-condensed">
                <tr>
                    <th>news id</th>
                    <th class="hidden-xs"><a href="" ng-click="sortField=sortField=='title'?'-title':'title'">title</a></th>
                    <th><a href="" ng-click="sortField=sortField=='category_name'?'-category_name':'category_name'">category</a></th>
                ...
                <tr ng-repeat="news in newsall | filter:search | orderBy:sortField" ng-class="{ active:news.status == 0 }">
                    <td><% news.id %></td>
                    <td class="hidden-xs"><a href="/cms/news/<% news.id %>/view"><% news.title %></a> </td>
                    <td>
