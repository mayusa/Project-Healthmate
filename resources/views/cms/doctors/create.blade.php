...
<div ng-controller="CmsDoctorCreateCtrl">
  <div class="row">
    <div class="panel panel-default">
      <div class="panel-heading">
        <div class="row">
          <div class="col-sm-8 col-xs-12">
            <h5><strong>CMS Create Doctor </strong></h5>
          </div>
        </div>           
      </div>
      ...
      <div class="panel-body">
        ...
        <form id="doctor_form" action="/cms/doctors" method="POST" name="frm" novalidate>
          ...
          <div class="text-center">
            <button class="btn btn-lg btn-info col-xs-12 col-xs-offset-0 col-md-4 col-md-offset-4" ng-click="submitDoctor( $event )">Submit</button>
          </div>
