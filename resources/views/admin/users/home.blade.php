      ...
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title text-center">Are you sure <span ng-if="blockuser.status == 0" class="text-danger">block</span><span ng-if="blockuser.status == 1"class="text-success">unblock</span> <%blockuser.name%>?</h4>
          </div>
